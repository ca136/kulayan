...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'website_productimage', 'width', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ProductImage.width'
        db.alter_column(u'website_productimage', 'width', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
