...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'website_productimage', 'height', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ProductImage.height'
        db.alter_column(u'website_productimage', 'height', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))
    ...
    models = {
        ...
        u'website.cartitem': {
            ...
            'cart': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'cart_items'", 'to': u"orm['website.Cart']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'website.userprofile': {
            ...
            'session': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
