...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Colors.code'
        db.add_column(u'website_colors', 'code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Colors.code'
        db.delete_column(u'website_colors', 'code')
    ...
    models = {
        ...
        u'website.product': {
            ...
            'colors': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['website.Colors']", 'null': 'True', 'blank': 'True'}),
