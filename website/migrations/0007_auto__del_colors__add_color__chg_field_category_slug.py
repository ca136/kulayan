...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'website_category', 'slug', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Category.slug'
        db.alter_column(u'website_category', 'slug', self.gf('django.db.models.fields.CharField')(default='', max_length=128))
