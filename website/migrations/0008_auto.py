...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'website_product_color', (
        ...
        db.create_unique(u'website_product_color', ['product_id', 'color_id'])
    ...
    def backwards(self, orm):
        ...
        db.create_unique(u'website_product_colors', ['product_id', 'color_id'])

        # Removing M2M table for field color on 'Product'
        db.delete_table('website_product_color')
    ...
    models = {
        ...
        u'website.product': {
            ...
            'color': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['website.Color']", 'null': 'True', 'blank': 'True'}),
