...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Colors'
        db.create_table(u'website_colors', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'website', ['Colors'])

        # Adding M2M table for field colors on 'Product'
        db.create_table(u'website_product_colors', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('product', models.ForeignKey(orm[u'website.product'], null=False)),
            ('colors', models.ForeignKey(orm[u'website.colors'], null=False))
        ))
        db.create_unique(u'website_product_colors', ['product_id', 'colors_id'])


        # Changing field 'Product.publish_date'
        db.alter_column(u'website_product', 'publish_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Product.sale_end_date'
        db.alter_column(u'website_product', 'sale_end_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Deleting model 'Colors'
        db.delete_table(u'website_colors')

        # Removing M2M table for field colors on 'Product'
        db.delete_table('website_product_colors')


        # Changing field 'Product.publish_date'
        db.alter_column(u'website_product', 'publish_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Product.sale_end_date'
        db.alter_column(u'website_product', 'sale_end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        u'website.product': {
            ...
            'colors': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['website.Colors']", 'symmetrical': 'False'}),
