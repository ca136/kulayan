...
class ProductImage(models.Model):
    image = models.ImageField(upload_to=lambda i, fn: "images/products/%s" % (fn), blank=True, null=True)
...
post_save.connect(create_user_profile, sender=User, dispatch_uid="app.models.create_user_profile")
